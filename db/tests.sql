...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2018 at 01:06 PM
...
INSERT INTO `tests` (`id`, `nama`, `alamat`, `token`) VALUES
(1, 'Cahyo', 'Jl. Menujut kebenaran', 'D4061F78-48D4-6921-8C40-039DD485F290'),
(2, 'Cahyo', 'Jl. Menujut kebenaran', '05DA2318-E557-0E41-550A-3A0D1DA3239F'),
(3, 'Ethan Wiggins', '4948 Donec Rd.', 'A3111B1E-68D1-F948-AE09-138C520461C8'),
...
--
ALTER TABLE `tests`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;COMMIT;
